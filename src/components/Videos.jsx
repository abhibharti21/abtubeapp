    ...
    >
      <VStack w={'full'}>
        <HStack
          ...
          mb={'4'}
        >
          <Button h="fit-content" w={'fit-content'} bgColor="red" ml={'5'}>
            <BiPlay color="white" fontSize={'2rem'} />
          </Button>{' '}
          <Heading pl={'2'}>
            AbhiTube
            <Text as="sup" fontWeight={'thin'} fontSize="md">
              IN
            </Text>
          </Heading>
        </HStack>
        ...
        ></video>
        <VStack id="vs" alignItems={'flex-start'} overflowY={'auto'}>
          <Heading py={['1.5', '4']}>Video Title</Heading>
          <Text>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolore ex
            quod modi vitae ad, saepe dignissimos assumenda, perferendis aperiam
            eveniet repudiandae rerum quae. Ipsum voluptate temporibus suscipit
            dolore repellendus quis! Lorem ipsum dolor sit amet consectetur
          </Text>
        </VStack>
      </VStack>
      <VStack
